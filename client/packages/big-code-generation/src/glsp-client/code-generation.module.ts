...
import { CodeGenerationActionResponse, SelectFolderActionResponse } from '../common/code-generation.action.js';
...
export const codeGenerationModule = new FeatureModule((bind, _unbind, _isBound, _rebind) => {
    ...
    // Allow the SelectFolderActionResponse to propagate to the server
    bind(ExtensionActionKind).toConstantValue(SelectFolderActionResponse.KIND);
});
